...
//  {
//    tft.setCursor(150, 50); tft.setTextColor(TFTLCD_WHITE);
...
//           delay(70);
//           tft.fillRect(256, 21, 6, 8, TFTLCD_BLACK); tft.setCursor(254, 21); tft.setTextSize(1); tft.setTextColor(TFTLCD_WHITE); tft.print(x_scale); //print the current x scale value
...
//           delay(70);
//           tft.fillRect(312, 21, 6, 8, TFTLCD_BLACK); tft.setCursor(311, 21); tft.setTextSize(1); tft.setTextColor(TFTLCD_WHITE); tft.print(y_scale); //print the current y scale value
//           break; //restart 'for' loop
//         }
//       }
...
//           delay(70);
//           tft.fillRect(312, 21, 6, 8, TFTLCD_BLACK); tft.setCursor(310, 21); tft.setTextSize(1); tft.setTextColor(TFTLCD_WHITE); tft.print(y_scale); //print the current y scale value
//           break; //restart 'for' loop
//         }
//       } 
//      }
...
//  tft.setCursor(215, 3); tft.setTextColor(TFTLCD_GREEN); tft.setTextSize(2); tft.print("-"); //print "-"
//  tft.setCursor(244, 3); tft.print("+"); 
//  tft.drawFastVLine(234, 0, 20, TFTLCD_WHITE);
//  tft.setCursor(208, 21); tft.setTextColor(TFTLCD_WHITE); tft.setTextSize(1); tft.print("X Scale:"); tft.print(x_scale);
//}
//
...
//  tft.setCursor(271, 3); tft.setTextColor(TFTLCD_RED); tft.setTextSize(2); tft.print("-"); //print "-"
//  tft.setCursor(300, 3); tft.print("+");
//  tft.drawFastVLine(290, 0, 20, TFTLCD_WHITE);  
//  tft.setCursor(265, 21); tft.setTextColor(TFTLCD_WHITE); tft.setTextSize(1); tft.print("Y Scale:"); tft.print(y_scale);
//}
//
//
...
//  tft.fillRect(280, 216, 15, 8, TFTLCD_GREEN); tft.setCursor(296, 216); tft.print(" - X");
//  tft.fillRect(280, 224, 15, 8, TFTLCD_RED); tft.setCursor(296, 224); tft.print(" - Y");
//  tft.fillRect(280, 232, 15, 8, TFTLCD_BLUE); tft.setCursor(296, 232); tft.print(" - Z");  
//}
//
...
//  }
//    
//  tft.setCursor(254, 208); tft.setTextColor(TFTLCD_WHITE); tft.setTextSize(1); //Set text position, color
//  tft.print(displayHour); printDigits(displayMinute); printDigits(displaySecond);
