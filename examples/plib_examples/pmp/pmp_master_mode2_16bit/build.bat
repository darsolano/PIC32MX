...
REM Processor is not provided, use the default xc32-gcc build one
...
@echo on
xc32-gcc %SOURCE% -mprocessor=%PROCESSOR% -o %ELF_FILE_NAME% %INCLUDE_PATHS% %GCC_OPTIONS%
